...
def ResetState():
    state.loc = {'w1': (29,25), 'w2': (6,16), 'p1': (13,20), 'a1': (11,7)}
    state.hasMedicine = {'a1': 0, 'w1': 5, 'w2': 0}
    state.robotType = {'w1': 'wheeled', 'a1': 'uav', 'w2': 'wheeled'}
    state.status = {'w1': 'free', 'w2': 'free', 'a1': UNK, 'p1': UNK, (13,20): UNK}
    state.altitude = {'a1': 'high'}
    state.currentImage = {'a1': None}
    state.realStatus = {'w1': 'OK', 'p1': 'injured', 'w2': 'OK', 'a1': OK, (13, 20): 'clear'}
    state.realPerson = {(13,20): 'p1'}
    state.newRobot = {1: None}
    state.weather = {(13,20): "foggy"}
