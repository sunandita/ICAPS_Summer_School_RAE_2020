...
def ResetState():
    state.loc = {'w1': (9,27), 'w2': (12,17), 'p1': (22,22), 'a1': (16,27)}
    state.hasMedicine = {'a1': 0, 'w1': 0, 'w2': 0}
    state.robotType = {'w1': 'wheeled', 'a1': 'uav', 'w2': 'wheeled'}
    state.status = {'w1': 'free', 'w2': 'free', 'a1': UNK, 'p1': UNK, (22,22): UNK}
    state.altitude = {'a1': 'high'}
    state.currentImage = {'a1': None}
    state.realStatus = {'w1': 'OK', 'p1': 'injured', 'w2': 'OK', 'a1': OK, (22, 22): 'clear'}
    state.realPerson = {(22,22): 'p1'}
    state.newRobot = {1: None}
    state.weather = {(22,22): "clear"}
