...
def ResetState():
    state.loc = {'w1': (24,27), 'w2': (30,17), 'p1': (9,11), 'a1': (27,5)}
    state.hasMedicine = {'a1': 0, 'w1': 0, 'w2': 0}
    state.robotType = {'w1': 'wheeled', 'a1': 'uav', 'w2': 'wheeled'}
    state.status = {'w1': 'free', 'w2': 'free', 'a1': UNK, 'p1': UNK, (9,11): UNK}
    state.altitude = {'a1': 'high'}
    state.currentImage = {'a1': None}
    state.realStatus = {'w1': 'OK', 'p1': 'injured', 'w2': 'OK', 'a1': OK, (9, 11): 'clear'}
    state.realPerson = {(9,11): 'p1'}
    state.newRobot = {1: None}
    state.weather = {(9,11): "clear"}
