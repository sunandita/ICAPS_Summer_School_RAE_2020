...
def ResetState():
    state.loc = {'w1': (15,15), 'w2': (29,29), 'p1': (28,30), 'a1': (9,19)}
    state.hasMedicine = {'a1': 0, 'w1': 5, 'w2': 0}
    state.robotType = {'w1': 'wheeled', 'a1': 'uav', 'w2': 'wheeled'}
    state.status = {'w1': 'free', 'w2': 'free', 'a1': UNK, 'p1': UNK, (28,30): UNK}
    state.altitude = {'a1': 'high'}
    state.currentImage = {'a1': None}
    state.realStatus = {'w1': 'OK', 'p1': 'injured', 'w2': 'OK', 'a1': OK, (28, 30): 'clear'}
    state.realPerson = {(28,30): 'p1'}
    state.newRobot = {1: None}
    state.weather = {(28,30): "foggy"}
