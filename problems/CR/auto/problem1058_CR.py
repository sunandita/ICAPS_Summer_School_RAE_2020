...
# Embedded file name: ../../shared/problems/CR/problem1058_CR.py
...
def ResetState():
    ...
    state.load = {'r1': NIL}
    state.pos = {'c1':1,  'o1':4}
    state.containers = {1:[],  2:[],  3:[],  4:['o1'],  5:[],  6:[],  7:[],  8:[],  9:[],  10:[]}
...
tasks = {1:[
 ...
 3:[
  [
   'emergency', 'r1', 2, 1]]}
eventsEnv = {}
# okay decompiling __pycache__/problem1058_CR.cpython-36.pyc
